...
def randomA():
    ...
    group_str = ' '.join(str(element) for row in result for element in row)
    A += group_str + ' '

    print('\n' + str(len(result)) + ' ' + str(len(result[0])) + ' ')
    for row in result:
      print(" ".join(map(lambda x: f"{x:.6f}", row)))
...
'''
3 3 
0.609395 0.231906 0.158698
0.408058 0.024173 0.567769
0.347214 0.067991 0.584795
-----------------------------------------------------
iteration :  500 + diff : 3.6709682083300335
500
iteration :  1000 + diff : 3.6848024085669637
iteration 500
3 3 
0.699453 0.283947 0.016600
0.187270 0.508775 0.303955
0.105196 0.077088 0.817716

3 4 
0.686044 0.221649 0.076372 0.015936
0.000000 0.000000 0.354949 0.645051
0.066533 0.406617 0.281862 0.244988
